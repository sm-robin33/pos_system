    ...
    <div class="col-md-12">
      ...
      <div class="panel-heading">
          <strong>
            ...
            <span>List Of Draft-Purchases</span>
         </strong>
        </div>
        <?php 
...
?>
      <div class="row mt-5">
                  ...
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="index.php?page=purchase_list" class="btn btn-success float-right">Parchase List</a>
                  </div>
                  </div>
                  <div class="col-sm-2">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="index.php?page=edit_draft&referance=<?php echo (int)$row['referance'];?>" class="btn btn-info btn-xs"  title="Edit" data-toggle="tooltip">
                      <span ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>
                    </a>
                    <a href="index.php?page=delete_draft&referance=<?php echo (int)$row['referance'];?>" class="btn btn-danger btn-xs"  title="Delete" data-toggle="tooltip">
